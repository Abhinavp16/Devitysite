  ...
  return (
    <section id="contact" className="py-16 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Follow Us Section */}
        <div className="mt-16 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-8 mx-4 transition-colors duration-300">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Follow Us</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-3xl mx-auto">
            ...
            <button className="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 mb-3 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors">GitHub</span>
            </button>
            ...
            <a href="https://www.linkedin.com/in/devity-club-auc?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 mb-3 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </div>
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-blue-600 transition-colors">LinkedIn</span>
            </a>
            ...
            <a href="https://x.com/devity_club441?t=FM5tFNSHb3UhQPMPcI8J8w&s=09" className="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 mb-3 text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </div>
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors">X</span>
            </a>
            ...
            <a href="https://www.instagram.com/devity_club_auc?igsh=MWVtcnNoY295N2RnNQ==" className="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 mb-3 text-gray-500 dark:text-gray-400 group-hover:text-pink-500 transition-colors">
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-pink-500 transition-colors">Instagram</span>
            </a>
            ...
            <a href="https://discord.gg/p4wPhaBn" className="flex flex-col items-center group hover:transform hover:scale-105 transition-all duration-300">
              <div className="w-12 h-12 mb-3 text-gray-500 dark:text-gray-400 group-hover:text-indigo-500 transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-indigo-500 transition-colors">Discord</span>
            </a>
          </div>
        </div>
      </div>
