  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${isScrolled
        ? 'bg-gradient-to-r from-blue-800/95 via-blue-900/95 to-indigo-900/95 backdrop-blur-xl shadow-2xl py-2'
        : 'bg-gradient-to-r from-blue-600/90 via-blue-700/90 to-blue-800/90 backdrop-blur-lg shadow-lg py-4'
        }`}>
          ...
          <div className="flex justify-between items-center transition-all duration-300">
            ...
            <div className="flex items-center group cursor-pointer">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute -inset-3 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 rounded-full opacity-0 group-hover:opacity-30 blur-md transition-all duration-700 animate-pulse"></div>
                ...
                {/* Main logo container */}
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-full p-2 border border-white/20 group-hover:border-white/40 transition-all duration-500 group-hover:shadow-2xl">
                  <img
                    src={devityLogo}
                    alt="DevityClub Logo"
                    className="h-12 w-auto transform transition-all duration-700 ease-out group-hover:scale-125 cursor-pointer logo-glow"
                  ...
                  {/* Floating particles */}
                  <div className="absolute -top-1 -right-1 w-2 h-2 bg-blue-300 rounded-full opacity-0 group-hover:opacity-100 animate-ping transition-opacity duration-300"></div>
                  <div className="absolute -bottom-1 -left-1 w-1.5 h-1.5 bg-cyan-300 rounded-full opacity-0 group-hover:opacity-100 animate-pulse transition-opacity duration-300" style={{ animationDelay: '0.5s' }}></div>
              ...
              <div className="ml-3 relative overflow-hidden">
                <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-200 via-white to-cyan-200 bg-clip-text text-transparent transition-all duration-500 group-hover:scale-105">
              ...
              {['Home', 'Events', 'About', 'Team', 'Speakers', 'Contact'].map((item, index) => {
                ...
                return (
                  <a
                    ...
                    className="relative px-5 py-2.5 text-blue-100 hover:text-white transition-all duration-500 rounded-xl group overflow-hidden transform hover:scale-110 hover:-translate-y-1 shadow-md hover:shadow-xl"
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              >
                {/* Animated background */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-indigo-500/30 to-purple-500/20 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></div>
                ...
                {/* Glow effect */}
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 via-white to-blue-400 opacity-0 group-hover:opacity-30 blur-md transition-opacity duration-500 rounded-xl"></div>

                <svg className="w-5 h-5 mr-2 transition-all duration-500 group-hover:rotate-[360deg] group-hover:scale-110 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <span className="relative z-10 font-semibold">Admin Login</span>
              </a>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-3">
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 transition-all duration-500 relative z-10 ${isMenuOpen ? 'rotate-180 scale-110' : 'rotate-0 scale-100'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div className={`md:hidden overflow-hidden transition-all duration-700 ease-out ${isMenuOpen ? 'max-h-96 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-4'
            ...
            <div className="py-6 border-t border-blue-400/30 bg-gradient-to-b from-blue-700/50 to-blue-800/50 backdrop-blur-sm rounded-b-2xl mt-2">
              <div className="flex flex-col space-y-3">
                ...
                <a
                  href="/login.html"
                  className="relative text-left text-blue-100 hover:text-white hover:bg-gradient-to-r hover:from-blue-500/40 hover:to-purple-500/40 px-6 py-3 rounded-xl transition-all duration-500 transform hover:translate-x-3 hover:scale-105 border border-blue-400/50 hover:border-white/50 mt-4 group overflow-hidden block"
                >
                  {/* Button shimmer */}
