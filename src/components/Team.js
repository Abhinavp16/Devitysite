...
const Team = () => {
  const teamMembers = [
    ...
    { name: "Prof. Dr. Sumita Dave", role: "Vice Chancellor, Amity University, Chhattisgarh", image: img5, bio: "Educational leadership and academic innovation.", skills: ["Education", "Innovation", "Leadership"], social: { linkedin: "https://www.linkedin.com/in/prof-dr-sumita-dave-6a4950167?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    ...
    { name: "Mr. Aarekh Verma", role: "President", image: img13, bio: "Full-stack developer with 3+ years experience.", skills: ["JavaScript", "Python", "AWS"], social: { github: "#", linkedin: "#" } },
    { name: "Ms. Naina Sethia", role: "VicePresident", image: img14, bio: "Creative designer passionate about user experience.", skills: ["Figma", "Design Systems", "Prototyping"], social: { github: "https://github.com/nainasethia", linkedin: "https://www.linkedin.com/in/nainasethia?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Ms.Pari Jain", role: "Secretary", image: img15, bio: "Analytics expert working with big data solutions.", skills: ["Python", "SQL", "Tableau"], social: { github: " https://github.com/Pari-Jain31", linkedin: "https://www.linkedin.com/in/pari-jain-627731325?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Mr. Abhinav Pandey", role: "Tech Head", image: img16, bio: "iOS and Android development specialist.", skills: ["Swift", "Kotlin", "React Native"], social: { github: "#", linkedin: "#" } },
    { name: "Ms. Kiran Vishwakarma", role: "DevOps Lead", image: img17, bio: "Cybersecurity expert and ethical hacker.", skills: ["Security", "Penetration Testing", "Compliance"], social: { github: "#", linkedin: "http://www.linkedin.com/in/kirannvish" } },
    { name: "Mr. Kunal Sahu", role: "Ai/Ml Lead", image: img18, bio: "Product strategy and user research specialist.", skills: ["Product Strategy", "User Research", "Agile"], social: { github: "#", linkedin: "#" } },
    { name: "Ms. Vandana Singh", role: "Cloud Lead", image: img19, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/vandana-singh1105?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Ms. Nupur Goyal", role: "Open Source Lead", image: img20, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/nupur-goyal-0283b6321?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Ms. Harsha Hariyani", role: "PR Lead", image: img21, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/harsha-hariyani-b8b8b8321?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Ms. Ritika Jiwani", role: "PR Lead", image: img22, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/ritika-jiwnani-955884381" } },
    { name: "Mr. Krish Rawlley", role: "PR Lead", image: img23, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "#" } },
    { name: "Ms. Neha Biswal", role: "UI/UX Coordinator", image: img24, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/neha-biswal-b8b8b8321?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Mr. Bhabani Sankar Biswal", role: "Tech Coordinator", image: img25, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/bhabani-sankar-biswal?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Mr. Ashmit Gartia", role: "Student Coordinator", image: img26, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/ashmit-gartia-b8b8b8321?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Mr. Shreejay Anand", role: "Student Coordinator", image: img27, bio: "Infrastructure and deployment automation expert.", skills: ["Docker", "Kubernetes", "CI/CD"], social: { github: "#", linkedin: "https://www.linkedin.com/in/shreejay-anand-b8b8b8321?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } }
  ];
    ...
    <div key={index} className="group relative bg-gradient-to-br from-indigo-50 via-white to-cyan-50 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-700 p-8 text-center transform hover:-translate-y-4 border border-indigo-100 backdrop-blur-sm">
      ...
      <div className="relative z-10">
        <div className="w-32 h-32 bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl overflow-hidden ring-4 ring-white/50 group-hover:ring-indigo-200/50 transition-all duration-500 group-hover:scale-110">
          {member.image === "#" ? (
            <div className="w-full h-full bg-gradient-to-br from-white/90 to-indigo-50/90 rounded-full flex items-center justify-center text-indigo-600 text-4xl font-bold backdrop-blur-sm">
    ...
    <div key={index} className="group relative bg-gradient-to-br from-purple-50 via-white to-pink-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-6 text-center transform hover:-translate-y-3 border border-purple-100 backdrop-blur-sm">
      ...
      <div className="relative z-10">
        <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl overflow-hidden ring-4 ring-white/50 group-hover:ring-purple-200/50 transition-all duration-500 group-hover:scale-105">
          {member.image === "#" ? (
            <div className="w-full h-full bg-gradient-to-br from-white/90 to-purple-50/90 rounded-full flex items-center justify-center text-purple-600 text-2xl font-bold backdrop-blur-sm">
              {member.name.charAt(0)}
            </div>
          ) : (
            <img src={member.image} alt={member.name} className="w-full h-full object-cover rounded-full" />
