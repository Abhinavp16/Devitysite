...
const Team = () => {
  const teamMembers = [
    ...
    { name: "Er. Nisha Rathore", role: "Club Mentor, Assistant Professor,ASET,AUC", image: img8, bio: "Mentoring students and guiding technical excellence.", skills: ["Mentoring", "Leadership", "research","Teaching" , "Technology"], social: { linkedin: "https://www.linkedin.com/in/nishaa-pravesh-rathore?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
    { name: "Dr. Shikha Tiwari", role: "Club Mentor, Assistant Professor,ASET,AUC", image: img9, bio: "Academic guidance and research supervision.", skills: ["Research", "Teaching", "Mentoring"], social: { linkedin: "https://www.linkedin.com/in/dr-shikha-tiwari-b383061a0?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" } },
