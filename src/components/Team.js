...
const Team = () => {
  const teamMembers = [
    ...
    { name: "Mr. Abhinav Pandey", role: "Tech Head", image: img16, bio: "Overseeing technical projects and guiding development initiatives across all platforms.", skills: ["Full Stack Development", "Project Management", "Technical Leadership"], social: { github: "#", linkedin: "#" } },
    ...
    { name: "Mr. Kunal Sahu", role: "AI/ML Lead", image: img18, bio: "Spearheading artificial intelligence and machine learning projects and research.", skills: ["Machine Learning", "AI Research", "Python"], social: { github: "#", linkedin: "#" } },
